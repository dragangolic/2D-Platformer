...
class Level:
    def __init__(self):
        ...
        # sprite group setup
        self.visible_sprites = CameraGroup()  # this sprites draw anything
...
class CameraGroup(pygame.sprite.Group):
    def __init__(self):
        ...
        self.camera_rect = pygame.Rect(cam_top, cam_left, cam_width, cam_height)

    def custom_draw(self, player):
        # get the player offset
        # self.offset.x = player.rect.centerex - self.half_w
        # self.offset.y = player.rect.centerex - self.half_h
        ...
        # camera offset, this way player will be always in the center
